...
export const SocialIcon = (props: SocialIconProps) => {
  ...
  const renderIcon = useCallback(() => {
    ...
    switch (network || networkFromUrl) {
        ...
        return (
          <svg
            ...
            style={{
              width: finalSize,
              height: finalSize,
              color: nativeColor ? "#000000" : color,
            }}
          >
            <path
              fill="currentColor"
        ...
        return (
          <svg
            ...
            style={{
              width: finalSize,
              height: finalSize,
              color: nativeColor ? "#1da1f2" : color,
            }}
          >
            <path
              fill="currentColor"
        ...
        return (
          <svg
            ...
            style={{
              width: finalSize,
              height: finalSize,
              color: nativeColor ? "#5865F2" : color,
            }}
          >
            <path
              fill="currentColor"
      ...
      default:
        return <ImageErrorIcon size={finalSize} fill={color} />;
    }
