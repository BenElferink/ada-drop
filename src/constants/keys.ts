...
export const LOG_ROCKET_PROJECT_ID = process.env.NEXT_PUBLIC_LOG_ROCKET_PROJECT_ID
export const SLACK_WEBHOOK_URL = process.env.NEXT_PUBLIC_SLACK_WEBHOOK_URL
