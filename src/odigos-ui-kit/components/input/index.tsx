...
import { numbersOnly } from '@odigos/ui-kit/functions';
import { FieldLabel } from '../field-label';
import { FieldError } from '../field-error';
import { InputTypes, type SVG } from '@odigos/ui-kit/types';
import styled, { css } from 'styled-components';
import { EyeClosedIcon, EyeOpenIcon } from '@odigos/ui-kit/icons';
...
const Input: FC<InputProps> = ({ icon: Icon, buttonLabel, onButtonClick, hasError, errorMessage, title, tooltip, required, value, onChange, type = InputTypes.Text, name, ...props }) => {
  ...
  return (
    <Container>
      ...
      <InputWrapper $disabled={props.disabled} $hasError={hasError || !!errorMessage} $isActive={!!props.autoFocus}>
        ...
        <StyledInput
          data-id={name}
          type={revealSecret ? InputTypes.Text : type === InputTypes.Number ? InputTypes.Text : type}
