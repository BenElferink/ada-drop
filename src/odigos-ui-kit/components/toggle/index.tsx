...
const Toggle: FC<ToggleProps> = ({ title, tooltip, initialValue = false, onChange, disabled, allowPropagation = false, flipHorizontally }) => {
  ...
  return (
    <Container $disabled={disabled} onClick={handleToggle}>
      {!flipHorizontally && <ToggleSwitch $disabled={disabled} $isActive={isActive} />}
