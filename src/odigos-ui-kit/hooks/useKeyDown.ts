...
// Chat GPT scraped keys from: https://developer.mozilla.org/en-US/docs/Web/API/UI_Events/Keyboard_event_key_values
type Key =
  | 'Backspace'
  | 'Tab'
  | 'Enter'
...
const useKeyDown = ({ active, key, withAltKey, withCtrlKey, withShiftKey, withMetaKey }: KeyDownOptions, callback: (e: KeyboardEvent) => void) => {
  useEffect(() => {
