...
import type { Notification } from '@odigos/ui-kit/types';
...
export const useNotificationStore = create<StoreState>((set, get) => ({
  ...
  addNotification: (notif) => {
    ...
    const isSameNotification = (n: Notification) => n.type === notif.type && n.title === notif.title && n.message === notif.message && !n.dismissed;
